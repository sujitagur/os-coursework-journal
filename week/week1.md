...
Here, the VM has total of 3.8 GB of RAM and mostly is free since no heavy process is run yet. Swap is not set up. This confirms that the server has enough capacity for further performance workload and monitoring 
...
![df1](./w1-df1.png)
The result shows root filesystem (/dev/sda2) is 25GB total with only 12%been used. This confirm that I have plenty of space for future and cleanly configured.
